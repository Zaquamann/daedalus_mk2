#!/usr/bin/env python3
"""Train the capacity-fair lipreading baseline (`VOnlyFairWordResNet`, ~476K
params). Tests whether the lean V-only ceiling was head-capacity-limited."""
...
MODEL_PATH = os.path.join(SCRIPT_DIR, "models", "video_only_fair.pt")
CURVE_PNG = os.path.join(SCRIPT_DIR, "analysis", "video_only_fair_curves.png")
CURVE_CSV = os.path.join(SCRIPT_DIR, "analysis", "video_only_fair_curves.csv")
